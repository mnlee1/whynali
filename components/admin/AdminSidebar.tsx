...
import { Home, ClipboardCheck, Database, MessageCircle, CheckSquare, Video, Shield, FileText, Activity, TrendingUp } from 'lucide-react'
...
const NAV_ITEMS = [
    ...
    },
    {
        label: 'KPI 리포트',
        href: '/admin/kpi',
        icon: <TrendingUp className="w-4 h-4 shrink-0" strokeWidth={2} />,
    },
    {
        label: '시스템 모니터링',
