                    ...
                    {costsLoading ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-5 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200 flex flex-col justify-between">
                                ...
                                <p className="text-sm text-content-secondary mt-0.5">qwen3.6-27b</p>
                                        </div>
                                    </div>
                                ...
                                {showAiFeatures && (
                                    <div className="p-4 grid grid-cols-2 gap-1.5 border-t border-border">
                                        {[
                                            ...
                                            { label: '카테고리 자동 분류', desc: '이슈 카테고리 태깅', model: 'qwen3.6-27b', schedule: '30분' },
                                            { label: '커뮤니티 버스트 감지', desc: '급상승 커뮤니티 반응 탐지', model: 'qwen3.6-27b', schedule: '30분' },
                                            { label: '원인 기사 검색', desc: '이슈 원인 뉴스 자동 연결', model: 'qwen3.6-27b', schedule: '30분' },
                                            { label: '상위 이슈 연결', desc: '후속·파생 이슈 자동 연결', model: 'qwen3.6-27b', schedule: '30분' },
                                            ...
                                            { label: '타임라인 분류', desc: '전개·파생 단계 분류', model: 'gemini-3.5-flash-lite', schedule: '매시 30분' },
                                            { label: '이슈 종합 요약', desc: '이슈 종결 시 자동 생성', model: 'gemini-3.5-flash-lite', schedule: '자동' },
                                            { label: '토론 주제 생성', desc: '승인 이슈 대상', model: 'qwen3.6-27b', schedule: '매일 낮 12시' },
                                            { label: '투표 생성', desc: '승인 이슈 대상', model: 'qwen3.6-27b', schedule: '매일 낮 12시' },
                                            { label: '봇 댓글 생성', desc: '15개 페르소나 · 카테고리 가중치', model: 'qwen3.6-27b', schedule: '요일별 변동' },
