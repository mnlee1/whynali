...
## 작업 1: 관련 뉴스 선별
"이슈 제목"의 핵심 사건과 직접 관련된 뉴스만 선택. 인물/단어가 겹쳐도 다른 사건이면 반드시 제외.
예시:
- 이슈 "장원영 우리은행 광고 공개" → "장원영 외모 화제" (X), "장원영 우리은행 CF 촬영" (O)
- 이슈 "WBC 한국 8강" → "WBC 이탈리아 경기" (X), "한국 8강 확정" (O)
불확실하면 제외.
...
## 작업 3: 관련 커뮤니티 글 선별
"이슈 제목"의 핵심 사건과 직접 관련된 글만 선택. 인물/단어가 겹쳐도 다른 사건이면 반드시 제외.
