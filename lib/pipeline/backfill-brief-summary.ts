...
- threeLine: intro·bullets 내용을 종합해서 "상황 → 전개" 2줄로 다시 압축. 현재 상태나 결론은 넣지 말고 상황과 전개까지만 담아서, "그래서 지금은 어떻게 됐지?"라는 궁금증이 남게 열어두세요. 두 줄이 서로 겹치는 내용을 반복하지 않도록 각 줄에 다른 정보를 담을 것. 각 줄은 "~했어요", "~하고 있어요"처럼 친근한 해요체로 작성하고, "~습니다" 같은 하십시오체나 "~야", "~해" 같은 반말은 쓰지 말 것
...
JSON 응답:
{
  ...
  "brief": {"intro":"한 문장","bullets":["팩트1","팩트2"],"conclusion":"결론","threeLine":["상황 압축 1줄이에요","전개 압축 1줄이에요"]}
}`
