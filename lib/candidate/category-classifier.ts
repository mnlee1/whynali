...
{
    "category": "사회" | "정치" | "연예" | "스포츠" | "경제" | "기술" | "세계",
    "confidence": 0-100,
    "reason": "판단 이유 1-2문장"
}`
    ...
    try {
        ...
        // 카테고리 검증
        const validCategories = ['사회', '정치', '연예', '스포츠', '경제', '기술', '세계']
