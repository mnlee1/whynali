 ...
 *
 * 주의: 맥락에 따라 이슈 키워드가 될 수 있는 단어(경찰, 배우, 사건 등)는
 * 커뮤니티 급증 감지를 방해하므로 여기에 포함하지 않습니다.
 */
const GROUPING_STOPWORDS = new Set([
    // 기관·직책 중 단독으로 이슈 식별이 불가능한 것만 유지
    '시장', '대표', '대학', '교수', '학교', '병원', '회사', '기업',
    '위원회', '특검', '공수처', '검사', '판사', '변호사',
    // 법률·제도 용어 (단독으로 이슈 불가)
    '법인', '수사', '의혹', '혐의', '판결', '기소', '체포', '구속',
    // 뉴스 태그·수식어 (내용 키워드 아님)
    '발표', '관련',
    '뉴스', '기자', '취재', '단독', '속보', '긴급', '오늘', '실시간',
    // 연예 범용어 중 단독으로 이슈 불가한 것만 유지
    '스타', '셀럽', '연예', '연예계', '방송', '방송계',
    '출연', '등장', '활동', '복귀', '컴백', '데뷔', '은퇴',
    '화제', '관심', '주목', '인기', '열풍', '돌풍',
    // 엔터테인먼트 범용어 (제목·인물과 결합해야 의미 있음)
    '예능', '쇼', '공연', '무대',
