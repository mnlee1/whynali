...
async function main() {
  ...
  const dailySheet = XLSX.utils.aoa_to_sheet([
    ['날짜', '신규가입', '누적가입', '신규이슈', '승인이슈', '누적승인이슈', '반응', '누적반응', '투표', '누적투표', '댓글', '누적댓글', '숏폼_유튜브', '숏폼_인스타', '숏폼_틱톡', '페이지뷰(admin제외)'],
    ...dailyRows
  ])
  ...
  const monthlySheet = XLSX.utils.aoa_to_sheet([
    ['월', '신규가입', '누적가입', '신규이슈', '승인이슈', '누적승인이슈', '반응', '누적반응', '투표', '누적투표', '댓글', '누적댓글', '숏폼_유튜브', '숏폼_인스타', '숏폼_틱톡', '페이지뷰(admin제외)'],
    ...monthlyRows
  ])
  monthlySheet['!cols'] = [
